...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__signup__ = __webpack_require__(801);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_providers_user_providers_user__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models_users__ = __webpack_require__(304);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_exercise_exercise__ = __webpack_require__(299);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__models_Exercise__ = __webpack_require__(727);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SignupPage = (function () {
    function SignupPage(navCtrl, user, toastCtrl, translateService, alertCtrl, storage, userService, exerciseService) {
        var _this = this;
    ...
    SignupPage.prototype.doSignUp = function () {
        var _this = this;
        this.userService.getOneUser(this.account.name).subscribe(function (data) {
            if (data.username === "alreadyexists") {
                _this.signUp();
            }
            else {
                _this.repeatUsername();
                _this.show = false;
            }
        });
    };
    SignupPage.prototype.signUp = function () {
        ...
        var user = new __WEBPACK_IMPORTED_MODULE_8__models_users__["a" /* UserModel */]();
        ...
        this.userService.createUser(user).subscribe(function (response) {
            ...
            var bench = new __WEBPACK_IMPORTED_MODULE_10__models_Exercise__["a" /* Exercise */];
            bench.exerciseName = "Bench Press";
            bench.variation = "Barbell";
            _this.mg = { id: 1, muscleGroupName: "Chest" };
            bench.MuscleGroup = _this.mg;
            _this.exerciseService.createExercise(_this.userService.getUser().id, bench).subscribe(function (data) {
                //console.log(data)
            });
            var squat = new __WEBPACK_IMPORTED_MODULE_10__models_Exercise__["a" /* Exercise */];
            squat.exerciseName = "Squat";
            squat.variation = "Barbell";
            _this.mg = { id: 3, muscleGroupName: "Legs" };
            squat.MuscleGroup = _this.mg;
            _this.exerciseService.createExercise(_this.userService.getUser().id, squat).subscribe(function (data) {
                //console.log(data)
            });
            var deadlift = new __WEBPACK_IMPORTED_MODULE_10__models_Exercise__["a" /* Exercise */];
            deadlift.exerciseName = "Deadlift";
            deadlift.variation = "Barbell";
            _this.mg = { id: 2, muscleGroupName: "Back" };
            deadlift.MuscleGroup = _this.mg;
            _this.exerciseService.createExercise(_this.userService.getUser().id, deadlift).subscribe(function (data) {
                //console.log(data)
            });
        });
        ...
        __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.auth().createUserWithEmailAndPassword(this.account.email, this.account.password)
            .then(function (value) {
            _this.user._user = _this.account.name;
            _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__pages__["b" /* MainPage */]);
        }).catch(function (error) {
            _this.firebaseErrors(error);
        });
    };
    SignupPage.prototype.firebaseErrors = function (error) {
    ...
    SignupPage.prototype.badPassword = function () {
    ...
    SignupPage.prototype.changeTerms = function () {
        //alert("Hey")
        if (this.terms == false) {
            this.terms = true;
        }
    ...
    SignupPage.prototype.noTerms = function () {
        var alert = this.alertCtrl.create({
    ...
    SignupPage.prototype.repeatUsername = function () {
        var alert = this.alertCtrl.create({
    ...
    SignupPage.prototype.termsOfUse = function () {
        var alert = this.alertCtrl.create({
            title: "Terms of Use",
...
SignupPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-signup',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/pages/signup/signup.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{ \'SIGNUP_TITLE\' | translate }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <form (submit)="doSignUp();">\n    <ion-list>\n\n      <ion-item>\n        <ion-label fixed>{{ \'USERNAME\' | translate }}</ion-label>\n        <ion-input type="text" [(ngModel)]="account.name" name="name" placeholder="{{ \' TestUser1\' | translate }}"></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <ion-label fixed>{{ \'EMAIL\' | translate }}</ion-label>\n        <ion-input type="email" [(ngModel)]="account.email" name="email" placeholder="{{ \'testUser@example.com\' | translate }}"></ion-input>\n      </ion-item>\n      <!--\n      <ion-item>\n        <ion-label floating>Username</ion-label>\n        <ion-input type="text" [(ngModel)]="account.username" name="username"></ion-input>\n      </ion-item>\n      -->\n      <ion-item>\n        <ion-label fixed>{{ \'PASSWORD\' | translate }}</ion-label>\n        <ion-input type="password" [(ngModel)]="account.password" name="password"></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <ion-label >{{ \'Confirm Password\' | translate }}</ion-label>\n        <ion-input type="password" [(ngModel)]="confirmPassword" name="password"></ion-input>\n      </ion-item>\n\n      <div padding>\n        <button on-click="termsOfUse()" ion-button type="button" color="primary" block>{{ "Terms of Use" | translate }}</button>\n      </div>\n\n      <ion-item>\n        <ion-label>I Agree to the Terms of Use</ion-label>\n        <ion-checkbox (ionChange)="changeTerms()"></ion-checkbox>\n      </ion-item>\n\n      <div padding>\n        <button ion-button color="primary" block>{{ \'SIGNUP_BUTTON\' | translate }}</button>\n      </div>\n\n      <h3 *ngIf="show" >Loading\n      </h3>\n\n    </ion-list>\n  </form>\n</ion-content>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/pages/signup/signup.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_5__providers_providers__["h" /* User */],
        __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* ToastController */],
        __WEBPACK_IMPORTED_MODULE_1__ngx_translate_core__["c" /* TranslateService */],
        __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["b" /* AlertController */],
        __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */],
        __WEBPACK_IMPORTED_MODULE_7__providers_providers_user_providers_user__["a" /* ProvidersUserProvider */],
        __WEBPACK_IMPORTED_MODULE_9__providers_exercise_exercise__["a" /* ExerciseProvider */]])
], SignupPage);
