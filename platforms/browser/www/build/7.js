webpackJsonp([7],Array(590).concat([
/* 590 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__friend_cardio_record_detail__ = __webpack_require__(890);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_exercise_exercise__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_Exercise__ = __webpack_require__(836);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_d3_selection__ = __webpack_require__(693);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_d3_scale__ = __webpack_require__(698);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_d3_array__ = __webpack_require__(613);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_d3_axis__ = __webpack_require__(812);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FriendCardioRecordDetailPage = (function () {
    function FriendCardioRecordDetailPage(navCtrl, navParams, records, alertCtrl, storage, exerciseService, userService) {
    ...
    FriendCardioRecordDetailPage.prototype.ionViewWillEnter = function () {
        ...
        this.userService.getCompetingUsersCardioHistoryByIdAndExercise(this.exercise, this.user.id).subscribe(function (data) {
    ...
    FriendCardioRecordDetailPage.prototype.sortRecords = function () {
        this.cardioRecords.sort(function (a, b) {
            if (a.reps < b.reps) {
                return -1;
            }
            else if (a.reps > b.reps) {
    ...
    FriendCardioRecordDetailPage.prototype.initSvg = function () {
        this.svg = __WEBPACK_IMPORTED_MODULE_6_d3_selection__["a" /* select */]("#barCardio")
            .append("svg")
            .attr("width", '100%')
            .attr("height", '100%')
    ...
    FriendCardioRecordDetailPage.prototype.initAxis = function () {
        this.x = __WEBPACK_IMPORTED_MODULE_7_d3_scale__["a" /* scaleBand */]().rangeRound([0, this.width]).padding(0.1);
        this.y = __WEBPACK_IMPORTED_MODULE_7_d3_scale__["b" /* scaleLinear */]().rangeRound([this.height, 0]);
        this.x.domain(this.cardioRecords.map(function (d) { return d.max; }));
        this.y.domain([0, __WEBPACK_IMPORTED_MODULE_8_d3_array__["d" /* max */](this.cardioRecords, function (d) { return d.mph; })]);
    };
    FriendCardioRecordDetailPage.prototype.drawAxis = function () {
        this.g.append("g")
            .attr("class", "axis axis--x")
            .attr("transform", "translate(0," + this.height + ")")
            .call(__WEBPACK_IMPORTED_MODULE_9_d3_axis__["a" /* axisBottom */](this.x))
            .append("text")
        ...
        this.g.append("g")
            ...
            .call(__WEBPACK_IMPORTED_MODULE_9_d3_axis__["b" /* axisLeft */](this.y))
            .append("text")
            .attr("class", "axis-title")
    ...
    FriendCardioRecordDetailPage.prototype.saveExercise = function (exercise) {
        var _this = this;
...
FriendCardioRecordDetailPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-friend-cardio-record-detail',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/pages/friend-cardio-record-detail/friend-cardio-record-detail.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{exercise.exerciseName}}</ion-title>\n    <ion-buttons right>\n      <button ion-button icon-only (click)="saveExercise(exercise);">\n        <ion-icon name="add"></ion-icon>\n      </button>\n    </ion-buttons>\n\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n	<ion-item no-lines>\n    <div class="rectable">\n      <table>\n        \n      </table>\n      <ion-scroll scrollY="true" class="scroll">\n        <table>\n          <tr>\n            <th></th>\n            <th>Time</th>\n            <th>Miles</th>\n            <th>MPH</th>\n            <th width="10px">Records</th>\n          </tr>\n          <tr *ngFor="let x of cardioRecords " [ngClass]="{red: x.records == 1, green: x.records > 1 && x.records < 5, silver: x.records > 4 && x.records < 10, gold: x.records > 9 }">\n            <td class="bold">{{x.min}}-{{x.max}}min</td>\n            <td>{{x.time}}</td>\n            <td>{{x.miles}}</td>\n            <td>{{x.mph.toFixed(1)}}</td>\n            <td>{{x.records}}</td>\n          </tr>\n        </table>\n      </ion-scroll>\n    </div>\n  </ion-item>\n  <ion-item no-lines>\n		<svg id="barCardio"></svg>\n	</ion-item>\n</ion-content>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/pages/friend-cardio-record-detail/friend-cardio-record-detail.html"*/,
    }),
