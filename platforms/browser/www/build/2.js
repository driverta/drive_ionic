webpackJsonp([2],Array(594).concat([
/* 594 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GainsPageModule", function() { return GainsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gains__ = __webpack_require__(895);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_gains_chart_gains_chart__ = __webpack_require__(896);
...
var GainsPageModule = (function () {
    function GainsPageModule() {
    }
    return GainsPageModule;
}());
GainsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__gains__["a" /* GainsPage */],
            __WEBPACK_IMPORTED_MODULE_3__components_gains_chart_gains_chart__["a" /* GainsChartComponent */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__gains__["a" /* GainsPage */]),
        ],
    })
], GainsPageModule);

//# sourceMappingURL=gains.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GainsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(74);
...
var GainsPage = (function () {
    function GainsPage(navCtrl, navParams, actShtCtrl, storage, userService, historyService) {
        ...
        this.other = 0;
        this.cardio = 0;
        this.cardioHistory = new Array();
        this.liftingHistory = new Array();
        this.filter = "";
        this.margin = { top: 50, right: 110, bottom: 50, left: 45 };
        this.data = [
            [
    ...
    GainsPage.prototype.ionViewDidLoad = function () {
        ...
        this.other = 0;
        this.cardio = 0;
        this.historyService.getCardioHistory(this.user.id).subscribe(function (cardioHistory) {
            _this.cardioHistory = cardioHistory;
            _this.cardioHistory.forEach(function (ch) {
                _this.cardio += ch.gains;
            });
            _this.historyService.getLiftingHistory(_this.user.id).subscribe(function (liftingHistory) {
                _this.liftingHistory = liftingHistory;
                _this.liftingHistory.forEach(function (lh) {
                    switch (lh.exercise.MuscleGroup.muscleGroupName) {
                        case "Chest":
                            _this.chest += lh.gains;
                            break;
                        case "Back":
                            _this.back += lh.gains;
                            break;
                ...
                _this.allTime = _this.cardio + _this.back + _this.chest + _this.arms + _this.core + _this.arms + _this.shoulders + _this.legs;
                _this.data[0][0].value = _this.chest / _this.allTime;
                _this.data[0][1].value = _this.back / _this.allTime;
                _this.data[0][2].value = _this.legs / _this.allTime;
                _this.data[0][3].value = _this.shoulders / _this.allTime;
                _this.data[0][4].value = _this.arms / _this.allTime;
                _this.data[0][5].value = _this.core / _this.allTime;
                _this.data[0][6].value = _this.cardio / _this.allTime;
                console.log(_this.allTime);
                _this.radarChart("#gainsChart", _this.data, _this.radarChartOptions);
            });
        });
    };
    GainsPage.prototype.filterGains = function () {
        var _this = this;
    ...
    GainsPage.prototype.executeFilter = function () {
        var _this = this;
        this.data[0] = [];
        this.exercises = {};
        this.xGains = 0;
        this.liftingHistory.forEach(function (lf) {
            if (lf.exercise.MuscleGroup.muscleGroupName == _this.filter) {
                _this.xGains += lf.gains;
                if (_this.exercises[lf.exercise.exerciseName]) {
                    _this.exercises[lf.exercise.exerciseName] += lf.gains;
                }
                else {
                    _this.exercises[lf.exercise.exerciseName] = lf.gains;
                }
        ...
        Object.keys(this.exercises).forEach(function (key) {
            var percent = _this.exercises[key] / _this.xGains;
            console.log(percent);
    ...
    GainsPage.prototype.radarChart = function (id, data, options) {
        var cfg = {
            w: 600,
            h: 600,
        ...
        var rScale = __WEBPACK_IMPORTED_MODULE_5_d3_scale__["b" /* scaleLinear */]()
            .range([0, radius])
            .domain([0, maxValue]);
        /////////////////////////////////////////////////////////
        ...
        __WEBPACK_IMPORTED_MODULE_4_d3_selection__["a" /* select */](id).select("svg").remove();
        //Initiate the radar chart SVG
        var svg = __WEBPACK_IMPORTED_MODULE_4_d3_selection__["a" /* select */](id).append("svg")
        ...
        var radarLine = __WEBPACK_IMPORTED_MODULE_6_d3_shape__["d" /* radialLine */]()
            .curve(__WEBPACK_IMPORTED_MODULE_6_d3_shape__["b" /* curveLinearClosed */])
            .radius(function (d) { return rScale(d.value); })
            .angle(function (d, i) { return i * angleSlice; });
        if (cfg.roundStrokes) {
            radarLine.curve(__WEBPACK_IMPORTED_MODULE_6_d3_shape__["a" /* curveCardinalClosed */]);
        }
        ...
        */
        ...
        function wrap(text, width) {
            text.each(function () {
                var text = __WEBPACK_IMPORTED_MODULE_4_d3_selection__["a" /* select */](this), words = text.text().split(/\s+/).reverse(), word, line = [], lineNumber = 0, lineHeight = 1.4, // ems
...
GainsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-gains',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/pages/gains/gains.html"*/'<ion-header>\n\n  <ion-navbar>\n  	<ion-buttons right>\n      <button ion-button icon-only (click)="filterGains()">\n        <ion-icon name="funnel"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>Gains</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n	\n	<ion-item no-lines>\n		<div id="chart">\n			<svg id="gainsChart"></svg>\n		</div>\n	</ion-item>\n</ion-content>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/pages/gains/gains.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
        ...
        __WEBPACK_IMPORTED_MODULE_2__providers_providers__["a" /* HistoryProvider */]])
], GainsPage);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GainsChartComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var GainsChartComponent = (function () {
    /*
    ...
    data = [
      ...
      */
    function GainsChartComponent() {
        console.log('Hello GainsChartComponent Component');
    ...
    return GainsChartComponent;
}());
GainsChartComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'gains-chart',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/components/gains-chart/gains-chart.html"*/'<div>\n	<ion-item no-lines>\n		<svg id="gainsChart"></svg>\n	</ion-item>\n	\n</div>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/components/gains-chart/gains-chart.html"*/
    }),
    __metadata("design:paramtypes", [])
], GainsChartComponent);

//# sourceMappingURL=gains-chart.js.map
