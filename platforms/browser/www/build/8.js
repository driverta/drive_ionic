...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__discover__ = __webpack_require__(880);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_competing__ = __webpack_require__(835);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_fcm_fcm__ = __webpack_require__(100);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DiscoverPage = (function () {
    function DiscoverPage(alertCtrl, navCtrl, navParams, userService, fcm) {
    ...
    DiscoverPage.prototype.addToLeaderboard = function (item) {
        var _this = this;
        this.id = item.id;
        var competing = new __WEBPACK_IMPORTED_MODULE_4__models_competing__["a" /* CompetingModel */];
        ...
        this.userService.addCompetingUser(competing).subscribe(function (data) {
            ...
            if (data === "already_exists") {
                ...
                _this.fcm.sendCompetingNotification(item.username, _this.userService.getUser().username);
                _this.playerAdded();
            }
        });
        // var check = true;
