webpackJsonp([3],Array(598).concat([
/* 598 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FriendGainsPageModule", function() { return FriendGainsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__friend_gains__ = __webpack_require__(901);
...
var FriendGainsPageModule = (function () {
    function FriendGainsPageModule() {
    }
    return FriendGainsPageModule;
}());
FriendGainsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__friend_gains__["a" /* FriendGainsPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__friend_gains__["a" /* FriendGainsPage */]),
        ],
    })
], FriendGainsPageModule);

//# sourceMappingURL=friend-gains.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FriendGainsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_providers__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_d3_selection__ = __webpack_require__(693);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_d3_scale__ = __webpack_require__(698);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_d3_shape__ = __webpack_require__(837);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FriendGainsPage = (function () {
    function FriendGainsPage(navCtrl, actShtCtrl, navParams, userService, historyService) {
    ...
    FriendGainsPage.prototype.ionViewDidLoad = function () {
        ...
        this.historyService.getCardioHistory(this.user.id).subscribe(function (cardioHistory) {
            ...
            _this.historyService.getLiftingHistory(_this.user.id).subscribe(function (liftingHistory) {
                ...
                _this.radarChart("#gainsChart2", _this.data, _this.radarChartOptions);
            });
        });
    };
    FriendGainsPage.prototype.filterGains = function () {
        var _this = this;
    ...
    FriendGainsPage.prototype.executeFilter = function () {
        var _this = this;
        this.data[0] = [];
        this.exercises = {};
        this.xGains = 0;
        Object.keys(this.sets).forEach(function (key) {
            if (_this.sets[key].muscle == _this.filter) {
                if (typeof _this.sets[key].exercise == "string") {
                    _this.xGains = _this.xGains + _this.sets[key].gains;
                    if (_this.exercises[_this.sets[key].exercise]) {
                        _this.exercises[_this.sets[key].exercise] = _this.exercises[_this.sets[key].exercise] + _this.sets[key].gains;
                    }
                    else {
                        _this.exercises[_this.sets[key].exercise] = _this.sets[key].gains;
                    }
                }
            }
        });
    ...
    FriendGainsPage.prototype.radarChart = function (id, data, options) {
        //alert("HERE")
        //console.log(id);
        //console.log(data);
        //console.log(options);
        ...
        var rScale = __WEBPACK_IMPORTED_MODULE_4_d3_scale__["b" /* scaleLinear */]()
            .range([0, radius])
            .domain([0, maxValue]);
        /////////////////////////////////////////////////////////
        ...
        __WEBPACK_IMPORTED_MODULE_3_d3_selection__["a" /* select */](id).select("svg").remove();
        //Initiate the radar chart SVG
        var svg = __WEBPACK_IMPORTED_MODULE_3_d3_selection__["a" /* select */](id).append("svg")
        ...
        var radarLine = __WEBPACK_IMPORTED_MODULE_5_d3_shape__["d" /* radialLine */]()
            .curve(__WEBPACK_IMPORTED_MODULE_5_d3_shape__["b" /* curveLinearClosed */])
            .radius(function (d) { return rScale(d.value); })
            .angle(function (d, i) { return i * angleSlice; });
        if (cfg.roundStrokes) {
            radarLine.curve(__WEBPACK_IMPORTED_MODULE_5_d3_shape__["a" /* curveCardinalClosed */]);
        }
        ...
        */
        ...
        function wrap(text, width) {
            text.each(function () {
                var text = __WEBPACK_IMPORTED_MODULE_3_d3_selection__["a" /* select */](this), words = text.text().split(/\s+/).reverse(), word, line = [], lineNumber = 0, lineHeight = 1.4, // ems
...
FriendGainsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-friend-gains',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/pages/friend-gains/friend-gains.html"*/'<ion-header>\n\n  <ion-navbar>\n  	<ion-buttons right>\n      <button ion-button icon-only (click)="filterGains()">\n        <ion-icon name="funnel"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>Gains</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n	<ion-item no-lines>\n		<div id="chart">\n			<svg id="gainsChart2"></svg>\n		</div>\n	</ion-item>\n</ion-content>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/pages/friend-gains/friend-gains.html"*/,
    }),
