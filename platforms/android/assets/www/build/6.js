webpackJsonp([6],Array(477).concat([
/* 477 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FriendCardioRecordDetailPageModule", function() { return FriendCardioRecordDetailPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__friend_cardio_record_detail__ = __webpack_require__(768);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_friend_cardio_profile_records_friend_cardio_profile_records__ = __webpack_require__(748);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_friend_cardio_profile_bar_friend_cardio_profile_bar__ = __webpack_require__(747);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pipes_pipes_module__ = __webpack_require__(579);
...
var FriendCardioRecordDetailPageModule = (function () {
...
FriendCardioRecordDetailPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_3__friend_cardio_record_detail__["a" /* FriendCardioRecordDetailPage */],
            __WEBPACK_IMPORTED_MODULE_4__components_friend_cardio_profile_records_friend_cardio_profile_records__["a" /* FriendCardioProfileRecordsComponent */],
            __WEBPACK_IMPORTED_MODULE_5__components_friend_cardio_profile_bar_friend_cardio_profile_bar__["a" /* FriendCardioProfileBarComponent */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__friend_cardio_record_detail__["a" /* FriendCardioRecordDetailPage */]),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FriendCardioProfileBarComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(149);
...
var FriendCardioProfileBarComponent = (function () {
    ...
    FriendCardioProfileBarComponent.prototype.makeChart = function () {
        var _this = this;
        var queryHistory = __WEBPACK_IMPORTED_MODULE_8_firebase___default.a.database().ref('/' + this.username + '/exercises/' + this.exercise.name + '-' + this.exercise.variation + '/history');
    ...
    FriendCardioProfileBarComponent.prototype.initAxis = function () {
        ...
        this.y.domain([0, __WEBPACK_IMPORTED_MODULE_6_d3_array__["d" /* max */](this.records._chart, function (d) { return d.mph; })]);
    };
...
FriendCardioProfileBarComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'friend-cardio-profile-bar',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\friend-cardio-profile-bar\friend-cardio-profile-bar.html"*/'<div>\n\n	<ion-item no-lines>\n\n		<svg id="barCardio"></svg>\n\n	</ion-item>\n\n</div>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\friend-cardio-profile-bar\friend-cardio-profile-bar.html"*/
    }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FriendCardioProfileRecordsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(149);
...
var FriendCardioProfileRecordsComponent = (function () {
    ...
    FriendCardioProfileRecordsComponent.prototype.getRecords = function () {
        var _this = this;
        var queryHistory = __WEBPACK_IMPORTED_MODULE_3_firebase___default.a.database().ref('/' + this.username + '/exercises/' + this.exercise.name + '-' + this.exercise.variation + '/history');
        queryHistory.once("value").then(function (snapshot) {
            _this.loop = 0;
            snapshot.forEach(function (childSnapshot) {
                _this.loop++;
...
FriendCardioProfileRecordsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'friend-cardio-profile-records',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\friend-cardio-profile-records\friend-cardio-profile-records.html"*/'<div>\n\n  <ion-item no-lines>\n\n    <div class="rectable">\n\n      <table>\n\n        \n\n      </table>\n\n      <ion-scroll scrollY="true" class="scroll">\n\n        <table>\n\n          <tr>\n\n            <th></th>\n\n            <th>Time</th>\n\n            <th>Miles</th>\n\n            <th>MPH</th>\n\n            <th width="10px">Records</th>\n\n          </tr>\n\n          <tr *ngFor="let x of rec " [ngClass]="{red: x.records == 1, green: x.records > 1 && x.records < 5, silver: x.records > 4 && x.records < 10, gold: x.records > 9 }">\n\n            <td class="bold">{{x.min}}-{{x.max}}min</td>\n\n            <td>{{x.time}}</td>\n\n            <td>{{x.miles}}</td>\n\n            <td>{{x.mph.toFixed(1)}}</td>\n\n            <td>{{x.records}}</td>\n\n          </tr>\n\n        </table>\n\n      </ion-scroll>\n\n    </div>\n\n  </ion-item>\n\n</div>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\friend-cardio-profile-records\friend-cardio-profile-records.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FriendCardioRecordDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_providers__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_d3_array__ = __webpack_require__(500);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_d3_axis__ = __webpack_require__(698);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_friend_cardio_profile_bar_friend_cardio_profile_bar__ = __webpack_require__(747);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_friend_cardio_profile_records_friend_cardio_profile_records__ = __webpack_require__(748);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_firebase__ = __webpack_require__(152);
...
var FriendCardioRecordDetailPage = (function () {
    function FriendCardioRecordDetailPage(navCtrl, navParams, records, alertCtrl, storage) {
        this.navCtrl = navCtrl;
    ...
    FriendCardioRecordDetailPage.prototype.getRecords = function () {
        var _this = this;
        var queryHistory = __WEBPACK_IMPORTED_MODULE_10_firebase___default.a.database().ref('/' + this.username + '/exercises/' + this.exercise.name + '-' + this.exercise.variation + '/history');
        queryHistory.once("value").then(function (snapshot) {
            _this.loop = 0;
            snapshot.forEach(function (childSnapshot) {
                _this.loop++;
    ...
    FriendCardioRecordDetailPage.prototype.saveExercise = function () {
        var _this = this;
        this.bool = true;
        Object.keys(this.myLifts).forEach(function (key) {
            if (_this.myLifts[key].name == _this.exercise.name && _this.myLifts[key].variation == _this.exercise.variation) {
                _this.presentAlert();
                _this.bool = false;
            }
        });
    ...
    FriendCardioRecordDetailPage.prototype.presentAlert = function () {
    ...
    FriendCardioRecordDetailPage.prototype.exerciseAdded = function () {
        var alert = this.alertCtrl.create({
    ...
    FriendCardioRecordDetailPage.prototype.getExercises = function () {
        var _this = this;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_8__components_friend_cardio_profile_bar_friend_cardio_profile_bar__["a" /* FriendCardioProfileBarComponent */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_8__components_friend_cardio_profile_bar_friend_cardio_profile_bar__["a" /* FriendCardioProfileBarComponent */])
], FriendCardioRecordDetailPage.prototype, "barChart", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_9__components_friend_cardio_profile_records_friend_cardio_profile_records__["a" /* FriendCardioProfileRecordsComponent */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_9__components_friend_cardio_profile_records_friend_cardio_profile_records__["a" /* FriendCardioProfileRecordsComponent */])
], FriendCardioRecordDetailPage.prototype, "recordsTable", void 0);
FriendCardioRecordDetailPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-friend-cardio-record-detail',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\pages\friend-cardio-record-detail\friend-cardio-record-detail.html"*/'<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>{{exercise.name}}</ion-title>\n\n    <ion-buttons right>\n\n      <button ion-button icon-only (click)="saveExercise();">\n\n        <ion-icon name="add"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n	<ion-item no-lines>\n\n    <div class="rectable">\n\n      <table>\n\n        \n\n      </table>\n\n      <ion-scroll scrollY="true" class="scroll">\n\n        <table>\n\n          <tr>\n\n            <th></th>\n\n            <th>Time</th>\n\n            <th>Miles</th>\n\n            <th>MPH</th>\n\n            <th width="10px">Records</th>\n\n          </tr>\n\n          <tr *ngFor="let x of records._cardioRecords " [ngClass]="{red: x.records == 1, green: x.records > 1 && x.records < 5, silver: x.records > 4 && x.records < 10, gold: x.records > 9 }">\n\n            <td class="bold">{{x.min}}-{{x.max}}min</td>\n\n            <td>{{x.time}}</td>\n\n            <td>{{x.miles}}</td>\n\n            <td>{{x.mph.toFixed(1)}}</td>\n\n            <td>{{x.records}}</td>\n\n          </tr>\n\n        </table>\n\n      </ion-scroll>\n\n    </div>\n\n  </ion-item>\n\n  <ion-item no-lines>\n\n		<svg id="barCardio"></svg>\n\n	</ion-item>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\pages\friend-cardio-record-detail\friend-cardio-record-detail.html"*/,
    }),
