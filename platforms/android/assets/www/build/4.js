webpackJsonp([4],Array(593).concat([
/* 593 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__friend_record_detail__ = __webpack_require__(893);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_friend_profile_records_friend_profile_records__ = __webpack_require__(894);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_friend_profile_bar_friend_profile_bar__ = __webpack_require__(868);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pipes_pipes_module__ = __webpack_require__(687);
...
FriendRecordsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__friend_record_detail__["a" /* FriendRecordDetailPage */],
            __WEBPACK_IMPORTED_MODULE_4__components_friend_profile_records_friend_profile_records__["a" /* FriendProfileRecordsComponent */],
            __WEBPACK_IMPORTED_MODULE_5__components_friend_profile_bar_friend_profile_bar__["a" /* FriendProfileBarComponent */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__friend_record_detail__["a" /* FriendRecordDetailPage */]),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FriendProfileBarComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_d3_array__ = __webpack_require__(613);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_d3_axis__ = __webpack_require__(812);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FriendProfileBarComponent = (function () {
    function FriendProfileBarComponent(navParams, navCtrl, userService, records) {
    ...
    FriendProfileBarComponent.prototype.makeChart = function () {
        ...
        this.records._chart = [];
        console.log("data");
        this.userService.getCompetingUsersLiftingHistoryByIdAndExercise(this.exercise, this.user.id).subscribe(function (data) {
    ...
    FriendProfileBarComponent.prototype.getRecords = function () {
    ...
    FriendProfileBarComponent.prototype.setChart = function () {
        __WEBPACK_IMPORTED_MODULE_3_d3_selection__["b" /* selectAll */]("svg > *").remove();
        this.initSvg();
        this.initAxis();
        this.drawAxis();
        this.drawBars();
    ...
    FriendProfileBarComponent.prototype.initSvg = function () {
        this.svg = __WEBPACK_IMPORTED_MODULE_3_d3_selection__["a" /* select */]("#barChart")
            .append("svg")
            .attr("width", '100%')
            .attr("height", '100%')
    ...
    FriendProfileBarComponent.prototype.initAxis = function () {
        this.x = __WEBPACK_IMPORTED_MODULE_4_d3_scale__["a" /* scaleBand */]().rangeRound([0, this.width]).padding(0.1);
        this.y = __WEBPACK_IMPORTED_MODULE_4_d3_scale__["b" /* scaleLinear */]().rangeRound([this.height, 0]);
        this.x.domain(this.records._records.map(function (d) { return d.reps; }));
        this.y.domain([0, __WEBPACK_IMPORTED_MODULE_5_d3_array__["d" /* max */](this.records._records, function (d) { return d.oneRepMax; })]);
    };
    FriendProfileBarComponent.prototype.drawAxis = function () {
        this.g.append("g")
            .attr("class", "axis axis--x")
            .attr("transform", "translate(0," + this.height + ")")
            .call(__WEBPACK_IMPORTED_MODULE_6_d3_axis__["a" /* axisBottom */](this.x))
            .append("text")
        ...
        this.g.append("g")
            ...
            .call(__WEBPACK_IMPORTED_MODULE_6_d3_axis__["b" /* axisLeft */](this.y))
            .append("text")
            .attr("class", "axis-title")
...
FriendProfileBarComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'friend-profile-bar',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/components/friend-profile-bar/friend-profile-bar.html"*/'<div>\n	<ion-item no-lines>\n		<svg id="barChart"></svg>\n	</ion-item>\n</div>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/components/friend-profile-bar/friend-profile-bar.html"*/
    }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FriendRecordDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_providers__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_friend_profile_bar_friend_profile_bar__ = __webpack_require__(868);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_providers_user_providers_user__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_exercise_exercise__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models_Exercise__ = __webpack_require__(836);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FriendRecordDetailPage = (function () {
    function FriendRecordDetailPage(navCtrl, navParams, records, alertCtrl, storage, userService, exerciseService) {
        this.navCtrl = navCtrl;
    ...
    //   this.barChart.makeChart();
    // }
    FriendRecordDetailPage.prototype.saveExercise = function (exercise) {
        var _this = this;
    ...
    FriendRecordDetailPage.prototype.presentAlert = function () {
    ...
    FriendRecordDetailPage.prototype.exerciseAdded = function () {
        var alert = this.alertCtrl.create({
    ...
    FriendRecordDetailPage.prototype.getExercises = function () {
        var _this = this;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_14" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_4__components_friend_profile_bar_friend_profile_bar__["a" /* FriendProfileBarComponent */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_4__components_friend_profile_bar_friend_profile_bar__["a" /* FriendProfileBarComponent */])
], FriendRecordDetailPage.prototype, "barChart", void 0);
FriendRecordDetailPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-friend-record-detail',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/pages/friend-record-detail/friend-record-detail.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{exercise.exerciseName}}</ion-title>\n\n    <ion-buttons right>\n      <button ion-button icon-only (click)="saveExercise(exercise);">\n        <ion-icon name="add"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n	<friend-profile-records></friend-profile-records>\n	<friend-profile-bar></friend-profile-bar>\n</ion-content>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/pages/friend-record-detail/friend-record-detail.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
        ...
        __WEBPACK_IMPORTED_MODULE_5__providers_providers_user_providers_user__["a" /* ProvidersUserProvider */],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FriendProfileRecordsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_providers__ = __webpack_require__(175);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var FriendProfileRecordsComponent = (function () {
    function FriendProfileRecordsComponent(navParams, records, userService) {
        this.records = records;
        this.userService = userService;
        this.checkRec = false;
        this.exercise = navParams.get('item');
    ...
    FriendProfileRecordsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.records._records = [];
        this.records._chart = [];
        console.log("data");
    ...
    FriendProfileRecordsComponent.prototype.getRecords = function () {
        for (var _i = 0, _a = this.liftingHistory; _i < _a.length; _i++) {
            var history_1 = _a[_i];
            //console.log("here");
            this.checkRec = false;
    ...
    return FriendProfileRecordsComponent;
}());
FriendProfileRecordsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'friend-profile-records',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/components/friend-profile-records/friend-profile-records.html"*/'<div>\n  <ion-item no-lines>\n    <div class="rectable">\n      <table>\n        <tr>\n          <th>Reps</th>\n          <th>Weight</th>\n          <th>1RM</th>\n          <th>Records</th>\n        </tr>\n      </table>\n      <ion-scroll scrollY="true" class="scroll">\n        <table>\n          <tr *ngFor="let x of records._records | sortByReps " [ngClass]="{red: x.records == 1, green: x.records > 1 && x.records < 5, silver: x.records > 4 && x.records < 10, gold: x.records > 9 }">\n            <td class="bold">{{x.reps}}</td>\n            <td>{{x.weight}}</td>\n            <td>{{x.oneRepMax}}</td>\n            <td>{{x.records}}</td>\n          </tr>\n        </table>\n      </ion-scroll>\n    </div>\n  </ion-item>\n</div>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/components/friend-profile-records/friend-profile-records.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_2__providers_providers__["e" /* Records */],
        __WEBPACK_IMPORTED_MODULE_2__providers_providers__["d" /* ProvidersUserProvider */]])
...
//# sourceMappingURL=friend-profile-records.js.map
