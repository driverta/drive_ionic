webpackJsonp([2],Array(483).concat([
/* 483 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gains__ = __webpack_require__(775);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_gains_chart_gains_chart__ = __webpack_require__(776);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_d3_selection__ = __webpack_require__(574);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_d3_scale__ = __webpack_require__(584);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_d3_shape__ = __webpack_require__(716);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GainsPage = (function () {
    function GainsPage(navCtrl, navParams, actShtCtrl, storage) {
    ...
    GainsPage.prototype.ionViewDidLoad = function () {
        ...
        this.getGains().then(function (val) {
            ...
            val.forEach(function (set) {
                ...
                if (set.muscle == "Chest") {
                    _this.chest = _this.chest + set.gains;
                }
                if (set.muscle == "Back") {
                    _this.back = _this.back + set.gains;
                }
                if (set.muscle == "Legs") {
                    _this.legs = _this.legs + set.gains;
                }
                if (set.muscle == "Shoulders") {
                    _this.shoulders = _this.shoulders + set.gains;
                }
                if (set.muscle == "Arms") {
                    _this.arms = _this.arms + set.gains;
                }
                if (set.muscle == "Core") {
                    _this.core = _this.core + set.gains;
                }
                if (set.muscle == "Cardio") {
                    _this.cardio = _this.cardio + set.gains;
                }
            });
        }).then(function () {
    ...
    GainsPage.prototype.executeFilter = function () {
        ...
        this.getGains().then(function (val) {
            console.log(val);
            val.forEach(function (set) {
                if (set.muscle == _this.filter) {
                    if (typeof set.exercise == "string") {
                        _this.xGains = _this.xGains + set.gains;
                        if (_this.exercises[set.exercise]) {
                            _this.exercises[set.exercise] = _this.exercises[set.exercise] + set.gains;
                        }
                        else {
                            _this.exercises[set.exercise] = set.gains;
                        }
                    }
                }
            });
        }).then(function () {
            Object.keys(_this.exercises).forEach(function (key) {
                var name = key;
...
GainsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-gains',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\pages\gains\gains.html"*/'<ion-header>\n\n\n\n  <ion-navbar>\n\n  	<ion-buttons right>\n\n      <button ion-button icon-only (click)="filterGains()">\n\n        <ion-icon name="funnel"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>Gains</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n	\n\n	<ion-item no-lines>\n\n		<div id="chart">\n\n			<svg id="gainsChart"></svg>\n\n		</div>\n\n	</ion-item>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\pages\gains\gains.html"*/,
    }),
...
GainsChartComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'gains-chart',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\gains-chart\gains-chart.html"*/'<div>\n\n	<ion-item no-lines>\n\n		<svg id="gainsChart"></svg>\n\n	</ion-item>\n\n	\n\n</div>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\gains-chart\gains-chart.html"*/
    }),
