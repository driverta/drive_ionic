webpackJsonp([5],Array(481).concat([
/* 481 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__friend_record_detail__ = __webpack_require__(772);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_friend_profile_records_friend_profile_records__ = __webpack_require__(773);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_friend_profile_bar_friend_profile_bar__ = __webpack_require__(749);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_d3_array__ = __webpack_require__(500);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_d3_axis__ = __webpack_require__(698);
...
var FriendProfileBarComponent = (function () {
    ...
    FriendProfileBarComponent.prototype.makeChart = function () {
        ...
        var queryHistory = __WEBPACK_IMPORTED_MODULE_7_firebase___default.a.database().ref('/' + this.username + '/exercises/' + this.exercise.name + '-' + this.exercise.variation + '/history');
    ...
    FriendProfileBarComponent.prototype.initAxis = function () {
        ...
        this.y.domain([0, __WEBPACK_IMPORTED_MODULE_5_d3_array__["d" /* max */](this.records._records, function (d) { return d.oneRM; })]);
    };
...
FriendProfileBarComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'friend-profile-bar',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\friend-profile-bar\friend-profile-bar.html"*/'<div>\n\n	<ion-item no-lines>\n\n		<svg id="barChart"></svg>\n\n	</ion-item>\n\n</div>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\friend-profile-bar\friend-profile-bar.html"*/
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_friend_profile_bar_friend_profile_bar__ = __webpack_require__(749);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_firebase__ = __webpack_require__(152);
...
var FriendRecordDetailPage = (function () {
    function FriendRecordDetailPage(navCtrl, navParams, records, alertCtrl, storage) {
        this.navCtrl = navCtrl;
    ...
    FriendRecordDetailPage.prototype.getRecords = function () {
        var _this = this;
        var queryHistory = __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.database().ref('/' + this.username + '/exercises/' + this.exercise.name + '-' + this.exercise.variation + '/history');
        queryHistory.once("value").then(function (snapshot) {
            //alert("D")
            console.log(snapshot);
            snapshot.forEach(function (childSnapshot) {
    ...
    FriendRecordDetailPage.prototype.saveExercise = function () {
        var _this = this;
        this.bool = true;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_4__components_friend_profile_bar_friend_profile_bar__["a" /* FriendProfileBarComponent */]),
...
FriendRecordDetailPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-friend-record-detail',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\pages\friend-record-detail\friend-record-detail.html"*/'<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>{{exercise.name}}</ion-title>\n\n\n\n    <ion-buttons right>\n\n      <button ion-button icon-only (click)="saveExercise();">\n\n        <ion-icon name="add"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n	<friend-profile-records></friend-profile-records>\n\n	<friend-profile-bar></friend-profile-bar>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\pages\friend-record-detail\friend-record-detail.html"*/,
    }),
...
var FriendProfileRecordsComponent = (function () {
    function FriendProfileRecordsComponent(navParams, records) {
        this.records = records;
        this.exercise = navParams.get('item');
    }
...
FriendProfileRecordsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'friend-profile-records',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\friend-profile-records\friend-profile-records.html"*/'<div>\n\n  <ion-item no-lines>\n\n    <div class="rectable">\n\n      <table>\n\n        <tr>\n\n          <th>Reps</th>\n\n          <th>Weight</th>\n\n          <th>1RM</th>\n\n          <th>Records</th>\n\n        </tr>\n\n      </table>\n\n      <ion-scroll scrollY="true" class="scroll">\n\n        <table>\n\n          <tr *ngFor="let x of records._records | sortByReps " [ngClass]="{red: x.records == 1, green: x.records > 1 && x.records < 5, silver: x.records > 4 && x.records < 10, gold: x.records > 9 }">\n\n            <td class="bold">{{x.reps}}</td>\n\n            <td>{{x.weight}}</td>\n\n            <td>{{x.oneRM.toFixed(1)}}</td>\n\n            <td>{{x.records}}</td>\n\n          </tr>\n\n        </table>\n\n      </ion-scroll>\n\n    </div>\n\n  </ion-item>\n\n</div>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\friend-profile-records\friend-profile-records.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_2__providers_providers__["e" /* Records */]])
