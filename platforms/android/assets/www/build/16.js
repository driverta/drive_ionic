...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__signup__ = __webpack_require__(789);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages__ = __webpack_require__(153);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SignupPage = (function () {
    function SignupPage(navCtrl, user, toastCtrl, translateService, alertCtrl, storage) {
        var _this = this;
    ...
    SignupPage.prototype.doSignUp = function () {
        var _this = this;
        this.show = true;
        var query1 = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/users');
        query1.once("value").then(function (snapshot) {
            _this.loop = 0;
            snapshot.forEach(function (childSnapshot) {
                var childData1 = childSnapshot.val();
                _this.loop++;
                if (_this.account.name == childData1.name) {
                    _this.show = false;
                    _this.repeatUsername();
                    return;
                }
                if (snapshot.numChildren() == _this.loop && _this.show == true) {
                    _this.signUp();
                }
            });
        });
    ...
    SignupPage.prototype.signUp = function () {
        ...
        var name = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/users/' + this.account.name + '/name');
        name.set(this.account.name);
        localStorage.setItem("username", this.account.name);
        localStorage.setItem("status", "good");
        var email = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/users/' + this.account.name + '/email');
        email.set(this.account.email);
        var exercises = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/' + this.account.name + '/exercises');
        exercises.set(this.exercises);
        var competitors = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/' + this.account.name + '/competing');
