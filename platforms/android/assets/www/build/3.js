webpackJsonp([3],Array(479).concat([
/* 479 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__friend_gains__ = __webpack_require__(770);
...
var FriendGainsPage = (function () {
    function FriendGainsPage(navCtrl, actShtCtrl, navParams) {
    ...
    FriendGainsPage.prototype.ionViewDidLoad = function () {
        ...
        this.other = 0;
        this.cardio = 0;
        var queryGains = __WEBPACK_IMPORTED_MODULE_2_firebase___default.a.database().ref('/' + this.username + '/gains');
        queryGains.once("value").then(function (snapshot) {
            snapshot.forEach(function (childSnapshot) {
                ...
                _this.sets[key] = childData1;
                _this.allTime = _this.allTime + gains;
                if (muscle == "Chest") {
                    _this.chest = _this.chest + gains;
                }
                if (muscle == "Back") {
                    _this.back = _this.back + gains;
                }
                if (muscle == "Legs") {
                    _this.legs = _this.legs + gains;
                }
                if (muscle == "Shoulders") {
                    _this.shoulders = _this.shoulders + gains;
                }
                if (muscle == "Arms") {
                    _this.arms = _this.arms + gains;
                }
                if (muscle == "Core") {
                    _this.core = _this.core + gains;
                }
                if (muscle == "Cardio") {
                    _this.cardio = _this.cardio + gains;
                }
            });
        }).then(function () {
...
FriendGainsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-friend-gains',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\pages\friend-gains\friend-gains.html"*/'<ion-header>\n\n\n\n  <ion-navbar>\n\n  	<ion-buttons right>\n\n      <button ion-button icon-only (click)="filterGains()">\n\n        <ion-icon name="funnel"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>Gains</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n	<ion-item no-lines>\n\n		<div id="chart">\n\n			<svg id="gainsChart2"></svg>\n\n		</div>\n\n	</ion-item>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\pages\friend-gains\friend-gains.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */]])
], FriendGainsPage);
