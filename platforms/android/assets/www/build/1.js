webpackJsonp([1],Array(587).concat([
/* 587 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__exercise_detail__ = __webpack_require__(884);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_bar_chart_bar_chart__ = __webpack_require__(866);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_new_set_new_set__ = __webpack_require__(885);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_history_history__ = __webpack_require__(886);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_records_records__ = __webpack_require__(887);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_line_chart_line_chart__ = __webpack_require__(867);
...
ItemDetailPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_3__exercise_detail__["a" /* ItemDetailPage */],
            __WEBPACK_IMPORTED_MODULE_4__components_bar_chart_bar_chart__["a" /* BarChartComponent */],
            __WEBPACK_IMPORTED_MODULE_5__components_new_set_new_set__["a" /* NewSetComponent */],
            __WEBPACK_IMPORTED_MODULE_6__components_history_history__["a" /* HistoryComponent */],
            __WEBPACK_IMPORTED_MODULE_7__components_records_records__["a" /* RecordsComponent */],
            __WEBPACK_IMPORTED_MODULE_8__components_line_chart_line_chart__["a" /* LineChartComponent */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__exercise_detail__["a" /* ItemDetailPage */]),
...
var BarChartComponent = (function () {
    function BarChartComponent(navParams, navCtrl, records, storage, userService) {
    ...
    BarChartComponent.prototype.makeChart = function () {
        var _this = this;
        this.userService.getLiftingHistoryByIdAndExercise(this.exercise).subscribe(function (data) {
            _this.liftingHistory = data;
            console.log(_this.liftingHistory);
            _this.getRecords();
        });
    ...
    BarChartComponent.prototype.getRecords = function () {
        for (var _i = 0, _a = this.liftingHistory; _i < _a.length; _i++) {
            var history_1 = _a[_i];
            this.checkRec = false;
            for (var _b = 0, _c = this.records._records; _b < _c.length; _b++) {
                var record = _c[_b];
                if (history_1.reps == record.reps) {
                    this.checkRec = true;
                    if (history_1.weight > record.weight) {
                        record.weight = history_1.weight;
                        record.oneRepMax = history_1.oneRepMax;
                        record.records++;
                    }
                }
            }
            if (this.checkRec == false) {
                this.records._records.push({ reps: history_1.reps, weight: history_1.weight, oneRepMax: history_1.oneRepMax, records: 1 });
            }
        }
        this.sortRecords();
    };
    ...
    BarChartComponent.prototype.initSvg = function () {
        this.svg = __WEBPACK_IMPORTED_MODULE_4_d3_selection__["a" /* select */]("#barChart")
            .append("svg")
            .attr("width", '100%')
            .attr("height", '100%')
    ...
    BarChartComponent.prototype.initAxis = function () {
        ...
        this.y.domain([0, __WEBPACK_IMPORTED_MODULE_6_d3_array__["d" /* max */](this.records._records, function (d) { return d.oneRepMax; })]);
    };
    ...
    BarChartComponent.prototype.drawBars = function () {
        ...
        this.g.selectAll(".bar")
            ...
            .attr("y", function (d) { return _this.y(d.oneRepMax); })
            .attr("width", this.x.bandwidth())
            .attr("height", function (d) { return _this.height - _this.y(d.oneRepMax); });
    };
...
BarChartComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'bar-chart',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/components/bar-chart/bar-chart.html"*/'<div>\n	<ion-item no-lines>\n		<svg id="barChart"></svg>\n	</ion-item>\n</div>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/components/bar-chart/bar-chart.html"*/
    }),
...
var LineChartComponent = (function () {
    function LineChartComponent(navParams, history, storage, userService) {
    ...
    LineChartComponent.prototype.initAxis = function () {
        ...
        this.x2.domain(this.liftingHistory.map(function (d) { return d.date; }));
        this.y2.domain([0, __WEBPACK_IMPORTED_MODULE_7_d3_array__["d" /* max */](this.liftingHistory, function (d) { return d.oneRepMax; })]);
    };
    ...
    LineChartComponent.prototype.drawLine = function () {
        ...
        this.line = __WEBPACK_IMPORTED_MODULE_6_d3_shape__["c" /* line */]()
            ...
            .y(function (d) { return _this.y2(d.oneRepMax); });
        this.g2.append("path")
...
LineChartComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'line-chart',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/components/line-chart/line-chart.html"*/'<div>\n  <ion-item no-lines>\n		<svg id="lineChart"></svg>\n	</ion-item>\n</div>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/components/line-chart/line-chart.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_providers__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_bar_chart_bar_chart__ = __webpack_require__(866);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_line_chart_line_chart__ = __webpack_require__(867);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ItemDetailPage = (function () {
    function ItemDetailPage(navCtrl, navParams, items, records, levels, platform, storage, userService) {
        this.navCtrl = navCtrl;
        this.records = records;
        this.levels = levels;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_14" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_4__components_bar_chart_bar_chart__["a" /* BarChartComponent */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_4__components_bar_chart_bar_chart__["a" /* BarChartComponent */])
], ItemDetailPage.prototype, "barChart", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_14" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_5__components_line_chart_line_chart__["a" /* LineChartComponent */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_5__components_line_chart_line_chart__["a" /* LineChartComponent */])
], ItemDetailPage.prototype, "lineChart", void 0);
ItemDetailPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-exercise-detail',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/pages/exercise-detail/exercise-detail.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{ exercise.exerciseName }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content scrollY="false">\n\n  <div padding>\n	  <ion-segment [(ngModel)]="segment">\n	    <ion-segment-button (click)="hideCharts()" value="set">\n	      New Set\n	    </ion-segment-button>\n	    <ion-segment-button (click)="showLine()" value="history">\n	      History\n	    </ion-segment-button>\n	    <ion-segment-button (click)="showBar()" value="records">\n	      Records\n	    </ion-segment-button>\n	  </ion-segment>\n	</div>\n\n	<div [ngSwitch]="segment">\n	  <ion-list *ngSwitchCase="\'set\'">\n	    <new-set (myEvent)="ionViewWillEnter();"></new-set>\n	  </ion-list>\n\n	  <ion-list *ngSwitchCase="\'history\'">\n	  	<history (myEvent2)="ionViewWillEnter();"></history>\n	  </ion-list>\n\n	  <ion-list *ngSwitchCase="\'records\'">\n	    <records></records>\n	  </ion-list>\n\n	  <bar-chart [hidden]="selectedValue!=1" ></bar-chart>\n	  <line-chart [hidden]="selectedValue!=2" ></line-chart>\n\n	</div>\n</ion-content>\n\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/pages/exercise-detail/exercise-detail.html"*/
    }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NewSetComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_providers__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_LiftingHistory__ = __webpack_require__(337);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NewSetComponent = (function () {
    function NewSetComponent(navCtrl, navParams, alertCtrl, levels, records, storage, userService) {
        this.navCtrl = navCtrl;
    ...
    NewSetComponent.prototype.addSet = function () {
        var _this = this;
        this.lf = new __WEBPACK_IMPORTED_MODULE_4__models_LiftingHistory__["a" /* LiftingHistory */]();
        ...
        this.checkRec = false;
        this.points = true;
        for (var _i = 0, _a = this.records._records; _i < _a.length; _i++) {
            var record = _a[_i];
    ...
    // }
    NewSetComponent.prototype.newLevel = function (level) {
...
NewSetComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'new-set',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/components/new-set/new-set.html"*/'<div class="container">\n	<div class="levels">\n		<h2>LEVEL\n			<span class="sick"> {{xlevel}}</span> :\n			<span class="sick">{{xcurrent}}</span> /\n			<span class="sick">{{xtotal}}</span> GAINS</h2>\n	</div>\n	<div id="myProgress">\n		<div id="myBar" [ngStyle]="{\'width.%\' : progress}"></div>\n	</div>\n	<div class="breaker"></div>\n	<br />\n	<div class="container fields">\n		<div class="setbet">\n			<ion-item class="no-padding">\n				<ion-label floating>Weight</ion-label>\n				<ion-input [(ngModel)]="weight" type="number" #weightField="ngModel" required></ion-input>\n			</ion-item>\n\n			<div *ngIf="invalid && weightField.invalid" class="error-msg">Please enter a valid Weight</div>\n\n			<ion-item class="no-padding">\n				<ion-label floating>Reps</ion-label>\n				<ion-input [(ngModel)]="reps" type="number" required #repField="ngModel"></ion-input>\n			</ion-item>\n			<div *ngIf="invalid && repField.invalid" class="error-msg">Please enter number of Reps</div>\n			<br>\n			<br>\n			<button ion-button icon-only type="submit" id="add" (click)="addSet()">\n				<ion-icon name="add"></ion-icon>\n			</button>\n\n			<br>\n		</div>\n		<br>\n		<br>\n		<div *ngIf="bool" class="animation">\n			<h1>NEW RECORD!</h1>\n		</div>\n		<div *ngIf="points" class="points">\n			<h1>+ {{lf.gains}} gains!</h1>\n		</div>\n	</div>\n</div>'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/components/new-set/new-set.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
...
var HistoryComponent = (function () {
    function HistoryComponent(navParams, historyService, alertCtrl, storage, userService) {
    ...
    HistoryComponent.prototype.deleteSet = function (x) {
        ...
        this.historyService.removeLiftingHistory(x).subscribe(function (data) {
            _this.ngOnInit();
            console.log(data);
        });
    };
...
HistoryComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'history',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/components/history/history.html"*/'<div>\n  <ion-item >\n    <div class="scrollingtable">\n      <table class="table table-bordered" id="headers">\n        <tr>\n          <th>Date</th>\n          <th>Weight</th>\n          <th>Reps</th>\n          <th>1RM</th>\n          <th>Delete</th>\n        </tr>\n      </table>\n      <ion-scroll scrollY="true" class="scroll">\n        <table>\n          <tr *ngFor="let x of liftingHistory">\n            <td>{{x.date | date: \'MM/dd\'}}</td>\n            <td>{{x.weight}}</td>\n            <td>{{x.reps}}</td>\n            <td>{{x.oneRepMax}}</td>\n            <td>\n              <input type="button" value="X" class="remove" (click)="presentConfirm(x)">\n            </td>\n          </tr>\n        </table>\n      </ion-scroll>\n    </div></ion-item>\n  <!-- <table class="table">\n    <tr>\n      <th>Date</th>\n      <th>Weight</th>\n      <th>Reps</th>\n      <th>1RM</th>\n    </tr>\n  </table>\n\n  <ion-scroll scrollY="true" class="scroll">\n    <ion-list>\n\n      <ion-item-sliding *ngFor="let x of history._history.reverse()">\n\n        <ion-item>\n          <h2>{{x.date | date: \'MM/dd\'}}</h2>\n            \n          {{x.weight}} {{x.reps}}\n          <span class="historyItem">\n            \n          </span>\n          <ion-note class="historyItem">\n            \n          </ion-note>\n          <span class="historyItem">{{x.oneRM.toFixed(1)}}</span>\n        </ion-item>\n\n        <ion-item-options>\n          <button danger (click)="presentConfirm(x)"> Delete</button>\n        </ion-item-options>\n      </ion-item-sliding>\n\n    </ion-list>\n  </ion-scroll> -->\n\n</div>'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/components/history/history.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_3__providers_providers__["a" /* HistoryProvider */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
...
var RecordsComponent = (function () {
    function RecordsComponent(navParams, records, userService) {
        this.records = records;
        this.userService = userService;
        this.checkRec = false;
        this.exercise = navParams.get('exercise');
    ...
    RecordsComponent.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.records._records = [];
        this.records._chart = [];
        this.userService.getLiftingHistoryByIdAndExercise(this.exercise).subscribe(function (data) {
...
RecordsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'records',template:/*ion-inline-start:"/Users/dromazmj/Documents/drive_ionic/src/components/records/records.html"*/'<div>\n  <ion-item no-lines>\n    <div class="rectable">\n      <table>\n        <tr>\n          <th>Reps</th>\n          <th>Weight</th>\n          <th>1RM</th>\n          <th>Records</th>\n        </tr>\n      </table>\n      <ion-scroll scrollY="true" class="scroll">\n        <table>\n          <tr *ngFor="let x of records._records | sortByReps " [ngClass]="{red: x.records == 1, green: x.records > 1 && x.records < 5, silver: x.records > 4 && x.records < 10, gold: x.records > 9 }">\n            <td class="bold">{{x.reps}}</td>\n            <td>{{x.weight}}</td>\n            <td>{{x.oneRepMax}}</td>\n            <td>{{x.records}}</td>\n          </tr>\n        </table>\n      </ion-scroll>\n    </div>\n  </ion-item>\n</div>\n'/*ion-inline-end:"/Users/dromazmj/Documents/drive_ionic/src/components/records/records.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
