webpackJsonp([1],Array(475).concat([
/* 475 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__exercise_detail__ = __webpack_require__(763);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_bar_chart_bar_chart__ = __webpack_require__(745);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_new_set_new_set__ = __webpack_require__(764);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_history_history__ = __webpack_require__(765);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_records_records__ = __webpack_require__(766);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_line_chart_line_chart__ = __webpack_require__(746);
...
var BarChartComponent = (function () {
    ...
    BarChartComponent.prototype.initAxis = function () {
        ...
        this.y.domain([0, __WEBPACK_IMPORTED_MODULE_6_d3_array__["d" /* max */](this.records._records, function (d) { return d.oneRM; })]);
    };
...
BarChartComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'bar-chart',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\bar-chart\bar-chart.html"*/'<div>\n\n	<ion-item no-lines>\n\n		<svg id="barChart"></svg>\n\n	</ion-item>\n\n</div>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\bar-chart\bar-chart.html"*/
    }),
...
var LineChartComponent = (function () {
    ...
    LineChartComponent.prototype.initAxis = function () {
        ...
        this.y2.domain([0, __WEBPACK_IMPORTED_MODULE_7_d3_array__["d" /* max */](this.history._charts, function (d) { return d.oneRM; })]);
    };
...
LineChartComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'line-chart',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\line-chart\line-chart.html"*/'<div>\n\n  <ion-item no-lines>\n\n		<svg id="lineChart"></svg>\n\n	</ion-item>\n\n</div>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\line-chart\line-chart.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_3__providers_providers__["g" /* User */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_providers__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_bar_chart_bar_chart__ = __webpack_require__(745);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_line_chart_line_chart__ = __webpack_require__(746);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NewSetComponent = (function () {
    function NewSetComponent(navCtrl, navParams, user, alertCtrl, levels, records, storage) {
        this.navCtrl = navCtrl;
        this.user = user;
    ...
    NewSetComponent.prototype.setLevel = function () {
        ...
        this.getLevel().then(function (val) {
            if (val) {
                if (_this.xlevel > val) {
                    _this.newLevel(_this.xlevel);
                }
            }
            _this.storage.set(_this.username + '/level', _this.xlevel);
        });
    };
    ...
    NewSetComponent.prototype.getLevel = function () {
...
HistoryComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'history',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\history\history.html"*/'<div>\n\n  <ion-item >\n\n    <div class="scrollingtable">\n\n      <table id="headers">\n\n        <tr>\n\n          <th>Date</th>\n\n          <th>Weight</th>\n\n          <th>Reps</th>\n\n          <th>1RM</th>\n\n          <th>Delete</th>\n\n        </tr>\n\n      </table>\n\n      <ion-scroll scrollY="true" class="scroll">\n\n        <table>\n\n          <tr *ngFor="let x of history._history.reverse()">\n\n            <td>{{x.date | date: \'MM/dd\'}}</td>\n\n            <td>{{x.weight}}</td>\n\n            <td>{{x.reps}}</td>\n\n            <td>{{x.oneRM.toFixed(1)}}</td>\n\n            <td>\n\n              <input type="button" value="X" class="remove" (click)="presentConfirm(x)">\n\n            </td>\n\n          </tr>\n\n        </table>\n\n      </ion-scroll>\n\n    </div>\n\n  </ion-item>\n\n</div>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\history\history.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_3__providers_providers__["g" /* User */],
        __WEBPACK_IMPORTED_MODULE_3__providers_providers__["b" /* HistoryProvider */],
...
var RecordsComponent = (function () {
    function RecordsComponent(navParams, user, records) {
        this.user = user;
        this.records = records;
        this.exercise = navParams.get('item');
    }
...
RecordsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'records',template:/*ion-inline-start:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\records\records.html"*/'<div>\n\n  <ion-item no-lines>\n\n    <div class="rectable">\n\n      <table>\n\n        <tr>\n\n          <th>Reps</th>\n\n          <th>Weight</th>\n\n          <th>1RM</th>\n\n          <th>Records</th>\n\n        </tr>\n\n      </table>\n\n      <ion-scroll scrollY="true" class="scroll">\n\n        <table>\n\n          <tr *ngFor="let x of records._records | sortByReps " [ngClass]="{red: x.records == 1, green: x.records > 1 && x.records < 5, silver: x.records > 4 && x.records < 10, gold: x.records > 9 }">\n\n            <td class="bold">{{x.reps}}</td>\n\n            <td>{{x.weight}}</td>\n\n            <td>{{x.oneRM.toFixed(1)}}</td>\n\n            <td>{{x.records}}</td>\n\n          </tr>\n\n        </table>\n\n      </ion-scroll>\n\n    </div>\n\n  </ion-item>\n\n</div>\n\n'/*ion-inline-end:"C:\Users\Tommy\Desktop\Mom\drive_ionic\src\components\records\records.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */],
